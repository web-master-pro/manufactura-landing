<?php
    ...
    $subject        = "[Manufactura]";                            // Название сайта в квадратных скобках для подстановки в тему письма префиксом
    ...
    switch ($data["form"]) {
        case "form-cost":
            $headline = "Запрос на оценку часов онлайн";
            break;
        case "form-ask":
            $headline = "Вопрос";
            break;
        case "form-callback":
            $headline = "Запрос обратного звонка";
            break;
        default:
            $headline = "Заявка...";
    };
    ...
    if ($data["form"] != "form-callback") {
        $message .= "<p><strong>Email:</strong> " . $data["email"] . "</p>\r\n";
    };
    if ($data["form"] == "form-ask") {
